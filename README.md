...
Есть идея на основе этих исходников дать возможность самой платформе взаимодействовать с биржами, хотя скорее всего за это будет отвечать ДАО ГОСБАНК.

<details>
  <summary>Описание разработчиков CCXT скрыто под спойлером</summary>
